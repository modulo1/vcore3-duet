...
;=== !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ===;
M307 H1 R4.338 K0.635:0.312 D5.38 E1.35 S1.00 B0 V0.0                         ;; rapido2hf, pt1000, max31865

;=== gizmo7 - fan - hotend ===;
M950 F0 C"20.out2" Q250                                                       ;; create fan 0 (F0) on pin RRF.out2 (20.out2)
M106 P0 C"2510" S0 H1 T45 L255                                                ;; set fan 0 (P0) to thermostatic control (45C), full-speed (L255) named "tool"
...
;M92 E704.53
M92 E668.23
M203 E3600                                                                    ;; set max speed, jerk, acceleration
M205 E5.0
M201 E5000
...
M558 K1 P11 C"20.i2c.ldc1612" F18000 T18000 A20
...
M98 P"0:/sys/configSZPnormal.g"                                               ;; we're using SZP touch mode
