...
;M569 P121.0 S0 D2 ; 1LC config
M569 P20.0 S1 D2 ; EBB36 config
...
;M584 X0.3 Y0.4 Z0.0:0.1:0.2 E121.0 ; 1LC config
M584 X0.3 Y0.4 Z0.0:0.1:0.2 E20.0 ; EBB36 config
...
;M574 X1 S1 P"0.io3.in"   ; Mini5+ config
;M574 X1 S1 P"121.io2.in"  ; 1LC config
M574 X1 S1 P"20.io2.in"  ; EBB36 config
...
;M307 H0 R0.492 K0.279:0.000 D2.01 E1.35 S1.00 B0 ;old, slower?
M307 H0 R0.463 K0.319:0.000 D1.83 E1.35 S1.00 B0
...
;;; A = named hotend
;M308 S1 P"121.temp0" Y"thermistor" T100000 B4725 C7.060000e-8 A"hotend"   ; 1LC config
M308 S1 P"20.temp0" Y"thermistor" T100000 B4725 C7.060000e-8 A"e3drevo"    ; EBB36 config


;;; create heater output (H1) for hotend
;;; on toolboard.out0 (121.out0) and 
;;; map to sensor 1 (T1)
;M950 H1 C"121.out0" T1 ; 1LC config
M950 H1 C"20.out0" T1 ; EBB36 config
;;; on hotend (H1)
;;; B0 = disable bang-bang mode   
;;; and set PWM limit (S1.00)                                                  
M307 H1 B0 S1.00       
...
;;; Q = set PWM frequency in Hz. valid range: 0-65535
;;;  default: 500 for GpOut pins, 250 for fans and heaters   
;M950 F0 C"121.out2" Q250 ; 1LC config
M950 F0 C"20.out2" Q250 ; EBB36 config
...
;M558 P8 C"121.io0.in" H5 F300:120 T6000 A20 B0 ; 1LC config
M558 P8 C"^20.io0.in" H5:1 F300:120 T6000 A20 B0 ; EBB36 config
...
;;;M955 P
;M955 P121.0 I54 R10 ; 1LC config
;M955 P20.0 I10 R10 ; EBB36 config
M955 P20.0 I16 R10 ; EBB36 config
;M955 P121.0 I12 R10
...
M308 S2 P"20.temp1" Y"thermistor" A"RRF36" T100000 B4092
