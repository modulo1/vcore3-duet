...
M906 X1400 Y1400 Z1400 I30                                                            ;; set motor currents and motor idle factor in per cent, December 2023
...
M205 X3.3 Y3.3 Z4.2 P1                                                              ;; set maximum instantaneous speed changes (mm/min) and jerk policy
...
M201 X400.00 Y400.00 Z350.00                                                        ;; set accelerations (mm/s^2), orbiter v2
