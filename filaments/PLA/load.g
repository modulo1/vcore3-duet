...
; Set current tool temperature to 220C
G10 S220 
; Wait for the temperatures to be reached
M116 
; Display message
M291 P"Feeding filament..." R"Loading PLA" T5 
...
;;; note this value, you will need to add it to your start gcode
;;; to ensure your prime line prints properly
G1 E-10 F1800 
